...
const Details = () => {
  ...
  return (
    <div>
     ...
     data-aos-duration="3000" className="relative my-4 mx-auto flex flex-col  items-center max-w-lg gap-4 rounded-md shadow-md sm:py-8 sm:px-12 bg-gray-900 text-gray-100">
          <img
            src={img}
            alt="lodging..."
